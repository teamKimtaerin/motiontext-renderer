...
📊 현재 작업 상태:
[ ] M2.0.1: 핵심 스키마 마이그레이션 (라인 26-63)
    [ ] Define 시스템 구현 (라인 31-34)
    [ ] 필드명 리팩토링 (라인 36-40)
    [ ] 노드 ID 의무화 (라인 42-44)
    [ ] 기본 에셋 관리 (라인 46-48)
    
[ ] M2.0.2: 파서 및 타입 시스템 (라인 67-105)
    [ ] ScenarioParser v2.0 (라인 72-75)
    [ ] 상속 시스템 (라인 77-80)
    [ ] 타입 시스템 확장 (라인 82-85)
    [ ] domLifetime 자동 계산 (라인 87-90)
    
[ ] M2.0.3: 플러그인 v3.0 통합 (라인 109-148)
    [ ] DOM 경계 분리 (라인 114-117)
    [ ] 채널 합성 시스템 (라인 119-122)
    [ ] Plugin Context v3.0 (라인 124-127)
    [ ] 에셋 관리 통합 (라인 129-132)
    
[ ] M2.0.4: 마이그레이션 및 호환성 (라인 152-190)
    [ ] 자동 마이그레이션 도구 (라인 157-160)
    [ ] 하위 호환성 레이어 (라인 162-165)
    [ ] 데모 샘플 변환 (라인 167-170)
    [ ] 문서 및 검증 (라인 172-175)
